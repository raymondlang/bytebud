      ...
      <div className="friendslist-container">
        ...
        <div>
          {receivedRequestsArr.map((receivedRequest) => {
            return (
              <div
                className="friendslist-request-user-container"
                key={`friend${receivedRequest.senderUser.id}`}
              >
                <div className="friendslist-pic-username">
                  <div>
                    ...
                    <img
                      ...
                      src={receivedRequest.senderUser.prof_pic}
                      alt="profile_pic_user"
                    />{" "}
                  </div>
                  <div className="friendslist-username">
                    {" "}
                    {receivedRequest.senderUser.username.split("#")[0]}{" "}
                  </div>
                  <div className="friendslist-tag">
                    {" "}
                    #{receivedRequest.senderUser.username.split("#")[1]}{" "}
                  </div>
                </div>
              ...
              >
                <div className="friendslist-pic-username">
                  <div>
                    ...
                    <img
                      className="request-profile-image"
                      src={sentRequest.receiverUser.prof_pic}
                      alt="profile_pic_user"
                    />{" "}
                  </div>
                  <div className="friendslist-username">
                    {" "}
                    {sentRequest.receiverUser.username.split("#")[0]}{" "}
                  </div>
                  <div className="friendslist-tag">
                    {" "}
                    #{sentRequest.receiverUser.username.split("#")[1]}{" "}
                  </div>
                </div>
